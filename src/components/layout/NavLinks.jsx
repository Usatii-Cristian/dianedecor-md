        ...
        return (
          <li key={item.href}>
            <Link
              ...
              className="inline-flex min-h-11 items-center text-xs tracking-[0.14em] uppercase transition-colors duration-200 ease-out hover:text-accent-deep aria-[current=page]:underline aria-[current=page]:underline-offset-[6px]"
            >
              {item.label}
            </Link>
          </li>
